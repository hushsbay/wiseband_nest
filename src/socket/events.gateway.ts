...
@WebSocketGateway({ port: 3051, transports: ['websocket', 'polling'], cors: { origin: ['https://hushsbay.com:3051', 'http://localhost:5173'] }, namespace: hush.cons.appName, pingTimeout: 5000, pingInterval: 25000 })
