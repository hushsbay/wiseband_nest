...
@WebSocketGateway({ port: 8080, transports: ['websocket', 'polling'], cors: { origin: '*' }, namespace: hush.cons.appName, pingTimeout: 5000, pingInterval: 25000 })
...
//@WebSocketGateway({ port: 3051, transports: ['websocket', 'polling'], cors: { origin: '*' }, namespace: hush.cons.appName, pingTimeout: 5000, pingInterval: 25000 })
