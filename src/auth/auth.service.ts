...
export class AuthService {
    ...
    constructor(private userSvc: UserService, private jwtSvc: JwtService, @Inject(REQUEST) private readonly req: Request) {}
    ...
    async login(dto: Record<string, any>): Promise<ResJson> {
        ...
        try {
            ...
            const payload = { userid: obj.data.USER_ID, orgcd: obj.data.ORG_CD, toporgcd: obj.data.TOP_ORG_CD }
